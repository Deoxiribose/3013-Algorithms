/**
 *    Jacob's Note:  getchNewName() is the new fuction and concio relieved term of error. 
 * 
...
#include <conio.h>  // Included to use _getch
...
// Renamed from "getch()" ...
// ... this solved an overload error after including conio.h
char getchNewName() {
#ifdef _WIN32 // Windows implementation
    return _getch();
#else // Linux implementation
